...
from .validation import validate_mac, validate_path, validate_timestamp
...
class AsyncEventProcessor:
    ...
    async def _process_batch(
        self, events: List[Dict[str, Any]], worker_name: str
    ) -> None:
    ...
    async def _insert_events_batch(
        self, conn: aiosqlite.Connection, events: List[Dict[str, Any]]
    ) -> None:
