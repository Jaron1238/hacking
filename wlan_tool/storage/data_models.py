...
from typing import Counter, Dict, List, Optional, Set, Tuple, TypedDict
...
class Welford:
    ...
    def combine(self, other: "Welford") -> "Welford":
        ...
        combined.M2 = (
            self.M2 + other.M2 + self.n * delta1 * delta1 + other.n * delta2 * delta2
        )
...
class ClientState:
    ...
    def update_from_event(self, ev: dict, detailed_ies: bool = False):
        ...
        from ..utils import is_local_admin_mac, parse_ies
