...
AUTO_RETRAIN_MIN_CONFIRMED_LABELS: int = _config["ui"][
    "auto_retrain_min_confirmed_labels"
]
...
ADAPTIVE_SCAN_PRIORITY_WEIGHT: int = _config["scanning"][
    "adaptive_scan_priority_weight"
]
